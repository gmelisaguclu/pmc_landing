...
function Section4() {
  return (
    <div className="flex items-center justify-center  flex-col text-center  mt-16 pt-20 pb-20 max-w-full border-4 ">
      <div className="flex items-center justify-center  flex-col text-center max-w-[689px]  my-10">
        <h1 className="text-5xl font-normal leading-[55px] bg-gradient-to-r from-white to-[#FFFFFF33] bg-clip-text text-transparent mb-12 tracking-wider">
